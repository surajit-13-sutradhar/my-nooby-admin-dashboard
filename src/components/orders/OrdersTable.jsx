...
const OrdersTable = () => {
    ...
    const handleSearch = (e) => {
        ...
        setSearchTerm(term)
        const filtered = ORDER_DATA.filter((order) => order.id.toLowerCase().includes(term) || order.customer.toLowerCase().includes(term) || order.date.includes(term))
                    ...
                    <tbody className="divide divide-gray-700">
                        {filteredOrders.map((order) => (
                            ...
                            >
								...
								<td className='px-6 py-4 flex justify-center whitespace-nowrap text-sm text-gray-300'>
